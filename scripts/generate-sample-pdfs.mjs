...
async function generateSamplePDF(title, fileName, pageCount, category) {
  ...
  const outputPath = join(__dirname, '..', 'public', 'documents', fileName);
...
async function main() {
  ...
  console.log('\nThese PDFs are now in public/documents/ and will be served as static assets.');
  console.log('The packet generator will merge them correctly into the final submittal package.');
}
